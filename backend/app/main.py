...
from app.api.routes import auth, events, health, admin, flyer, signups, messages, photos, points, co_managers
...
app.include_router(co_managers.router, prefix="/api/v1")
